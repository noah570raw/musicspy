...
function renderResults(data) {
  ...
  $("resultTitle").textContent = data.civiliansWin ? "Шпион прайбал" : "Шпион красавчик";
  $("resultText").textContent = `Шпионом был ${data.spyName}. Тема: «${data.theme}». Зачервили: ${suspectedNames || "никто"}.`;
