...
const EN_TRANSLATIONS = {
  ...
  "Кинематичные подсказки": "Cinematic hints",
  ...
  "Подсказки реакций": "Reaction hints",
  ...
  "Переключатель языка теперь живет только в меню настроек.": "The language switch now lives only in settings.",
  ...
  "Войди через соцсети или останься гостем на одну партию.": "Sign in with social accounts or stay as a guest for one match.",
