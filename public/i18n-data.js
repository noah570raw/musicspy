...
const EN_TRANSLATIONS = {
  ...
  "операция: новая комната": "operation: new room",
  "Создание лобби": "Create lobby",
  "Собери правила матча в компактном командном центре — всё важное помещается на одном экране.": "Build the match rules in a compact command center — everything important fits on one screen.",
