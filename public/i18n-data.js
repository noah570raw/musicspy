...
const EN_TRANSLATIONS = {
  ...
  "secret analog operation": "secret analog operation",
  "Секретная музыкальная операция внутри luxury analog studio: собери комнату, включай улики и вычисляй шпиона по трекам.": "A secret music operation inside a luxury analog studio: gather a room, play clues, and expose the spy through tracks.",
