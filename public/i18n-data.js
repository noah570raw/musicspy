...
const EN_TRANSLATIONS = {
  ...
  "ночная музыкальная операция": "night music operation",
  ...
  "Собери комнату, получи секретную тему и ставь треки так, чтобы вычислить шпиона за 3 круга": "Gather a room, get a secret theme, and play tracks to expose the spy in 3 rounds",
  "Никнейм": "Nickname",
  "например, мотя": "e.g. motya",
  "твой сценический ник": "your stage alias",
