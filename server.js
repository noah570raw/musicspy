...
function pickTheme() {
  const themes = [
    ...
    "rage / opium вайб",
    "hyperpop",
    "грустный трек без кринжа",
    "мотивационный бэнгер",
    "аниме-опенинг",
    "k-pop, который зайдет всем",
    "rock classics",
    "punk energy",
    "edm festival vibes",
    "techno underground",
    ...
    "nostalgia vibes",
    "viral youtube songs",
    "инструментал с характером",
    "lofi beats",
    "experimental music",
    "песня для финальных титров",
    "трек, который знают только свои",
    "музыка для побега из города"
  ];
